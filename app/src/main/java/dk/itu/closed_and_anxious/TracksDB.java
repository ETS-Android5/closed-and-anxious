...
public class TracksDB extends ViewModel { // ViewModel - instanciated in activity it is kept and will live as long as the activity does
    ...
    public void fillItemsDB() {
        ...
        // Frustration tracks
        addTrack(R.raw.gently, "Gently Does It","An atmospheric, uplifting soundscape. Credit: Ketsa", "Frustration", R.drawable.cover_coffee1);
        addTrack(R.raw.life, "Choose Life", "An atmospheric lofi-tune with true dead-battery vibes. Credit: Daniel Birch", "Frustration", R.drawable.cover_ice_1);
        addTrack(R.raw.adrift15, "Adrift No. 15", "A cosmic string set to invoke wideness, wonder and calm. Credit: Daniel Birch", "Frustration", R.drawable.cover_plants_3);
        addTrack(R.raw.quad, "foldable quadcopter", "A deep, atmospheric electronic track for perspective and meditation. Credit: bibby", "Frustration", R.drawable.cover_darksand_4);
        addTrack(R.raw.dark, "Dark Water", "A mystical, layered soundscape to calm and stimulate overworked minds. Credit: Nul Tiel Records", "Frustration", R.drawable.cover_roses_2);
        addTrack(R.raw.last, "Last Light", "A simple compounding soundscape to meditate to. Credit: Nul Tiel Records", "Frustration", R.drawable.cover_ice_4);
        addTrack(R.raw.time, "Too Brief A Time To Be Anything", "A 45-minute cosmic meditation soundscape to settle your mind or drift asleep to. Credit: HoliznaCC0", "Frustration", R.drawable.cover_ice_3);
        addTrack(R.raw.waves, "Cosmic Waves", "A 33-minute deep meditation soundscape with calming, futuristic sounds. Credit: HoliznaCC0", "Frustration", R.drawable.cover_glow_2);
        addTrack(R.raw.amb1, "Ambience", "A well-rounded, focus track for attentive listening-meditations or focused work. Credit: Independent Music Licensing Collective", "Frustration", R.drawable.cover_darksand_2);
